...
#
  ...
  alias gll='git log --oneline "$argv" |awk '{print $1}' |tac|xargs'
  ...
  alias gpc='git push --set-upstream origin (__fish_git_current_branch)'
  alias gpp='git pull origin (__fish_git_current_branch) && git push origin (__fish_git_current_branch)'
