#!/usr/bin/env node
/**
 * Record FloquetTopoCA intro at 4K resolution.
 */
...
const HTML_FILE = 'intro-workflow-capture.html';
...
const OUTPUT_FILE = path.resolve(
  ...
  path.join(process.env.OBS_OUTPUT_DIR || path.join(os.homedir(), 'Movies'), 'intro_floquet_4k.mp4')
);
const WIDTH = 4096;
const HEIGHT = 2304;
const FPS = 60;
...
async function main() {
  console.log(`Recording FloquetTopoCA intro`);
