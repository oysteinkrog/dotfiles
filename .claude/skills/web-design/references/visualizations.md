...
Reference for generating diagrams, charts, and interactive visualizations within web pages. All visualizations load from CDN and work in self-contained HTML files.
...
mermaid.initialize({
  ...
  theme: 'base',
  themeVariables: {
    primaryColor: isDark ? 'oklch(0.22 0.022 250)' : 'oklch(0.93 0.010 245)',
    primaryBorderColor: isDark ? 'oklch(0.42 0.040 250)' : 'oklch(0.60 0.090 255)',
    primaryTextColor: isDark ? 'oklch(0.88 0 0)' : 'oklch(0.20 0 0)',
    secondaryColor: isDark ? 'oklch(0.22 0.022 20)' : 'oklch(0.95 0.010 20)',
    secondaryBorderColor: isDark ? 'oklch(0.48 0.060 22)' : 'oklch(0.58 0.100 22)',
    secondaryTextColor: isDark ? 'oklch(0.88 0 0)' : 'oklch(0.20 0 0)',
    tertiaryColor: isDark ? 'oklch(0.22 0.022 152)' : 'oklch(0.93 0.014 148)',
    tertiaryBorderColor: isDark ? 'oklch(0.44 0.060 152)' : 'oklch(0.56 0.080 152)',
    tertiaryTextColor: isDark ? 'oklch(0.88 0 0)' : 'oklch(0.20 0 0)',
    lineColor: isDark ? 'oklch(0.50 0 0)' : 'oklch(0.62 0 0)',
    fontSize: '14px',
    fontFamily: 'var(--font-body)',
    noteBkgColor: isDark ? 'oklch(0.22 0 0)' : 'oklch(0.97 0.006 85)',
    noteTextColor: isDark ? 'oklch(0.72 0 0)' : 'oklch(0.42 0 0)',
    noteBorderColor: isDark ? 'oklch(0.34 0 0)' : 'oklch(0.82 0 0)',
  }
});
```
...
const textColor = isDark ? 'oklch(0.70 0 0)' : 'oklch(0.42 0 0)';
const gridColor = isDark ? 'oklch(1.00 0 0 / 0.06)' : 'oklch(0 0 0 / 0.06)';
const bgColor = isDark ? 'oklch(0.19 0.012 250)' : 'oklch(0.98 0.008 85)';
```
...
new Chart(document.getElementById('myChart'), {
  ...
  data: {
    ...
    datasets: [{
      label: 'Revenue ($k)',
      data: [12, 19, 8, 15, 22],
      backgroundColor: isDark ? 'oklch(0.65 0.130 36 / 0.6)' : 'oklch(0.52 0.155 32 / 0.6)',
      borderColor: isDark ? 'oklch(0.65 0.130 36)' : 'oklch(0.52 0.155 32)',
      borderWidth: 1,
      borderRadius: 4,
    }]
  },
...
new Chart(document.getElementById('doughnut'), {
  ...
  data: {
    ...
    datasets: [{
      data: [40, 30, 20, 10],
      backgroundColor: ['oklch(0.52 0.155 32)', 'oklch(0.50 0.085 152)', 'oklch(0.42 0.138 258)', 'oklch(0.63 0.128 48)'],
      borderColor: isDark ? 'oklch(0.14 0.018 250)' : 'oklch(0.98 0.008 85)',
      borderWidth: 2,
    }]
  },
  options: {
...
.kpi-card__trend--up { color: oklch(0.50 0.085 152); }
.kpi-card__trend--down { color: oklch(0.52 0.155 32); }
...
.compare__header--before {
  background: oklch(0.52 0.155 32 / 0.1);
  color: oklch(0.52 0.155 32);
  border-bottom: 2px solid oklch(0.52 0.155 32);
}

.compare__header--after {
  background: oklch(0.50 0.085 152 / 0.1);
  color: oklch(0.50 0.085 152);
  border-bottom: 2px solid oklch(0.50 0.085 152);
}
...
.badge--success { background: oklch(0.50 0.085 152 / 0.15); color: oklch(0.50 0.085 152); }
.badge--warning { background: oklch(0.63 0.128 48 / 0.15); color: oklch(0.63 0.128 48); }
.badge--error { background: oklch(0.52 0.155 32 / 0.15); color: oklch(0.52 0.155 32); }
.badge--info { background: oklch(0.42 0.138 258 / 0.15); color: oklch(0.42 0.138 258); }
