...
- [Recovery primitives](#recovery-primitives)
- [Per-phase recovery](#per-phase-recovery)
- [What to do if the workspace is in an unknown state](#what-to-do-if-the-workspace-is-in-an-unknown-state)
- [What this doc explicitly DOESN'T cover](#what-this-doc-explicitly-doesnt-cover)
