...
- [Pattern-1: Levenshtein-1 typo correction for unknown flags](#pattern-1-levenshtein-1-typo-correction-for-unknown-flags)
- [Pattern-2: Add `--json` mode preserving human default](#pattern-2-add-json-mode-preserving-human-default)
- [Pattern-3: Honor NO_COLOR / TERM=dumb / CI=true](#pattern-3-honor-no_color--termdumb--citrue)
- [Pattern-4: Add `--robot-mode` capability surface](#pattern-4-add-robot-mode-capability-surface)
- [Pattern-5: Two-pass deprecation (alias-only flag)](#pattern-5-two-pass-deprecation-alias-only-flag)
- [Pattern-6: Stable structured error output](#pattern-6-stable-structured-error-output)
