...
Example:
  scripts/aggregate_scores.sh /path/to/mytool/agent_ergonomics_audit verb__list
  scripts/aggregate_scores.sh /path/to/mytool/agent_ergonomics_audit # all surfaces
EOF
}
