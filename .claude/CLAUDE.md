...
- **`~/.config/secrets/.env`**, mode 600, `KEY=VALUE` per line, no quotes. Single source of
  ...
  `AIOLOS_OBSERVE_URL`, `ANTHROPIC_API_KEY`, `ANTHROPIC_BASE_URL`, `APIFY_TOKEN`, `BROWSERBASE_API_KEY`, `CLOUDFLARE_API_TOKEN`, `DISCORD_USER_TOKEN`, `DISCORD_USER_TOKEN_MAIN`, `GH_PR_IMAGES_TOKEN`, `GITHUB_PERSONAL_ACCESS_TOKEN`, `GOG_KEYRING_PASSWORD`, `GOOGLE_OAUTH_CLIENT_ID`, `GOOGLE_OAUTH_CLIENT_SECRET`, `HF_TOKEN`, `HUBSPOT_ACCESS_TOKEN`, `JIRA_API_TOKEN`, `JIRA_EMAIL`, `JIRA_SITE`, `MAC_LOGIN_PASSWORD`, `MCP_AGENT_MAIL_TOKEN`, `RPI_SYNCBOX_PASSWORD`, `RPI_WIFI_PSK`, `RPI_WIFI_SSID`, `SENTRY_AUTH_TOKEN`, `SLACK_BOT_TOKEN`, `SLACK_CI_BOT_TOKEN`, `SLACK_TEAM_ID`, `TAILSCALE_API_KEY`, `ZENDESK_API_TOKEN`, `ZENDESK_EMAIL`, `ZENDESK_SUBDOMAIN`.
  <!-- END:secrets-keys -->
